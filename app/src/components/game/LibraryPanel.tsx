...
import { getLibraryStats, entryLesson } from "@/lib/game/library";
    ...
    return (
      <div className="flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <div className="text-[13px] leading-[1.7]" style={{ color: "var(--color-foreground)", opacity: 0.8 }}>
        ...
        {library.entries.map((entry) => (
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              <span
                className="text-[9px] tracking-[1px] px-1.5 py-0.5"
                style={{
              ...
              <span className="text-[9px] text-[var(--color-dim)] tracking-[1px]">
                +{entry.bonusXP} XP
              </span>
            </div>
            <div
            ...
            <div className="text-[13px] leading-[1.65] text-[var(--color-foreground)] opacity-90">
              {entryLesson(entry)}
            </div>
          </div>
        ))}
